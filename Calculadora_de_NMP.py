...
#ventana.iconbitmap(r"C:\Programación_ExL\Calculadora_NMP\tubo.ico")

ventana.geometry("300x500")
head = tk.Label(ventana, text = "Tablas - Cálculo para coliformes / 100 mL \nPara tubos con 10 mL, 1 mL y 0.1 mL de alícuota\nPor Rubén Téllez  v0.1.3 [3 decimales]", bg = "#faf0e6")
head.pack()
